...
export const qk = {
  ...
  episodes: (id: string, rev: number | null, params: Record<string, unknown>) => ['task', id, 'episodes', rev, params] as const,
  syncCurves: (id: string, ep: number, rev: number | null) => ['task', id, 'sync-curves', ep, rev] as const,
