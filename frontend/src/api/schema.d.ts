...
export interface components {
    schemas: {
        ...
        EpisodePreview: {
            ...
            /** @enum {unknown} */
            task_source: "原始标注" | "无";
            /** @description mcap (1.11): the episode has a task topic the preview does not read (its text is inside the file; the checks read it) - task is empty, but not because there is none */
            task_unread?: boolean;
            cameras: {
                name: string;
