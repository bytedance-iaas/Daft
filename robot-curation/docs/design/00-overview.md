...
D1–D15 来自两轮需求澄清，D16–D23 来自 2026-09-20 的设计评审，D24–D32 来自同日另一位评审者的 14 条问答。后续设计一律以此为准：
...
| 去掉终端 | 00 §5 | |
| 8 个模块 port 后完整一致，算法不能改，跑数据对比报告做检查 | 10 §2–3 | 有意差异列在 10 §3.0；v3 格式本期不做对账 |
...
| 任务级失败不影响整条流水线，报告里用「错误」表示 | 01 §3；04 §7 | D24 |
